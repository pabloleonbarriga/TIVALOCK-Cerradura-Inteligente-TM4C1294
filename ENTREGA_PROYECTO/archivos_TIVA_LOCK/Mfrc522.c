...
#define CHIPSELECT_BASE  0x40066000     //GPIO_PORTB_BASE
#define NRSTPD_BASE    0x40005000       //GPIO_PORTF_BASE
#define SSI_BASE       0x4000B000      //SSI2_BASE
//CHIPSELECTPIN = PB5
//NRSTPD = PF0
//SPIMODULO USADO = 2

void Mfrc522(int chipSelectPin, int NRSTPD)
{
